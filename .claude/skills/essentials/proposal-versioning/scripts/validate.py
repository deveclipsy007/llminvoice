...
REQUIRED = [
    ROOT / "SKILL.md",
    ROOT / "MANIFESTO.md",
    ROOT / "references" / "project-mapping.md",
    ROOT / "templates" / "version-payload.sample.json",
...
def main() -> int:
    ...
    if sample.get("skill") != "proposal-versioning":
    ...
    print("proposal-versioning validation passed")
    return 0

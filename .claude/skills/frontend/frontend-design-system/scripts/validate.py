...
REQUIRED = [
    ROOT / "SKILL.md",
    ROOT / "MANIFESTO.md",
    ROOT / "references" / "style-source-map.md",
    ROOT / "templates" / "admin-theme.tokens.css",
...
def main() -> int:
    ...
    if sample.get("skill") != "frontend-design-system":
        print("Invalid sample skill")
        return 1
    if golden.get("risk_label") != "caution":
        print("Invalid risk label")
        return 1

    print("frontend-design-system validation passed")
    return 0

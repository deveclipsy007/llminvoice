...
REQUIRED = [
    ROOT / "SKILL.md",
    ROOT / "MANIFESTO.md",
    ROOT / "templates" / "permissions.stub.php",
...
def main() -> int:
    ...
    if sample.get("skill") != "auth-rbac-hardening":
        print("Invalid sample skill")
        return 1
    if golden.get("risk_label") != "dangerous":
        print("risk label mismatch")
        return 1

    print("auth-rbac-hardening validation passed")
    return 0
